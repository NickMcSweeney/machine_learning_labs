...
disp("x/y before removal: " + size(y));
[x y] = RemoveData(x, y);
disp("x/y after removal: " + size(y));
...
%
% It seems that a slightly smaller alpha than the one provided (0.007 vs 0.01) might yeild slightly better results. dropping alpha further (0.001) results in a speed of convergance that doesn't converge inside the time frame, and an underapproximation for the linear regression. similarly a highter alpha (0.03) results in an over approximation.
% ============================================================
...
%
% started with 406, ended with 392.
